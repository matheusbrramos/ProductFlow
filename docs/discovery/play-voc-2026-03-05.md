...
| Crash Rate | 25.92% | ↘ melhorando (-8.8pp) | 🔴 |
| ANR Rate | N/A | → | 🟢 |
...
Do ponto de vista técnico, os vitals apontam crash rate médio de **25.92%** nos últimos 30 dias.
...
**Evidência:** 3 review(s) negativo(s) · severidade média 5.00/5 · vitals avg 12.96%
...
### 2. Usabilidade (UX/UI)
**Impacto estimado:** 13.6 | **Esforço:** S | **Dono sugerido:** Product Design

**Evidência:** 3 review(s) negativo(s) · severidade média 4.00/5 · vitals avg 12.96%
...
Total de segmentos de vitals na base: **530**

| Dimensão | Preenchida | Ausente | Situação |
|----------|-----------|---------|----------|
| Versão do app | 530 | 0 | ✅ Disponível |
| Modelo de dispositivo | 530 | 0 | ✅ Disponível |
| País | 530 | 0 | ✅ Disponível |

**Error Issues (stack traces / erros rastreados):** 0 registro(s) no período. Sem detalhes de erros específicos disponíveis via API.

> **Desalinhamento:** Crash rate de **25.92%** está elevado, mas os reviews não citam crashes. Usuários afetados podem estar desinstalando sem deixar avaliação — investigar taxa de retenção.
...
_Relatório gerado em 2026-03-05T13:33:50.804265+00:00 · Fonte: play_insights.duckdb · Janela de análise: 30 dias_
