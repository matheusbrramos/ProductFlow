...
|---------|-------|------|----------------|--------|
| Crash Rate | 0.2606 (26.06%) | 1.0000 (100.00%) | 12 dias | 🔴 Crítico |
| ANR Rate | 0.0000 (0.00%) | 0.0000 (0.00%) | 12 dias | 🟢 OK |
...
> **Impacto estimado no negócio:** A cada **4 tentativas de abrir o app**, **1 termina com o app fechando sozinho**. Se o app tem 10.000 sessões diárias, aproximadamente **2,606 usuários por dia** não conseguem usar o app. Cada crash = usuário que potencialmente abandona a compra, deixa avaliação negativa ou desinstala o app.
...
A versão ativa **20252** tem crash rate médio de **26.1%**.
...
|--------|-----------------|------|---------|
| 20252 | 26.1% | 12d | 2026-02-03 → 2026-03-02 |
...
|--|-----------------|-----------------|
| **Severidade Alta** | 🔴 Atacar agora<br>Experiência de Compra (Ingresso/Ticket) (3 · sev 5.0)<br>Usabilidade (UX/UI) (3 · sev 4.0) | 🟡 Investigar<br>— |
...
_Relatório semanal gerado em 2026-03-05T12:10:29.942115+00:00_
